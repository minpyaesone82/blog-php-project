        ...
        <div class="col-12 col-md-8">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-white my-2">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Search by &nbsp;<b>"<?php echo $_POST['searchKey'] ;?>"</b></li>
                </ol>
            </nav> 
            <?php 
                $result = search($_POST['searchKey']);
                if(count($result) == 0){
                   echo alert("There is no result");
                }
            ?>
            <?php foreach (search($_POST['searchKey']) as $fc ) {?>  
